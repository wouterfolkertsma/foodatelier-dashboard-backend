        ...
        <table class="uk-table uk-table-striped" id="tableForm">
            ...
            @foreach($data as $item)
                <tr>
                    ...
                    <td>
                        <a class="uk-button uk-button-secondary uk-button-small" href="{{ $item->data->file_path }}" download>Download</a>
                        ...
                        @if($item->data->imageable())
                            <div uk-lightbox class="d-inline">
                                <a class="uk-button uk-button-secondary uk-button-small" href="/{{ $item->data->file_path }}">View</a>
                            </div>
                        @endif
                    </td>
                </tr>
